...
export default function Navbar({onLogoClick}) {
  ...
  return (
    <nav className="  bg-zinc-800   shadow-md ">
      <div className="container mx-auto px-4 py-2 md:flex md:justify-between md:items-center mr-auto">
        <div className="flex items-center justify-between">
        <div>
        <img
            src={main_logo}
            alt="Logo"
            className="w-12 h-12 rounded-full cursor-pointer transition duration-100 hover:bg-gray-400 hover:bg-opacity-20"
            
          />
        </div>
          <a href="#" className="flex text-lg font-semibold text-white ml-5 mr-auto">
